      ...
      <main className="flex-1 flex flex-col items-center justify-center pt-28 pb-16 px-4 z-10 max-w-7xl mx-auto w-full">
        <div className="text-center space-y-6 max-w-3xl">
          <div className="inline-flex items-center space-x-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full text-xs text-cyan-400 font-mono tracking-wide">
            ...
            <span>Next Generation deep learning platform</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-4">
            <Link
              href="/login"
              className="px-8 py-3.5 text-sm font-semibold tracking-wide btn-cyber rounded-xl shadow-lg w-full sm:w-auto text-center"
            >
              Get Started
            </Link>
            <Link
              href="/dashboard"
              className="px-8 py-3.5 text-sm font-semibold tracking-wide border border-slate-800 hover:border-slate-700 bg-slate-950/40 rounded-xl hover:bg-slate-900/50 transition-all w-full sm:w-auto text-center"
            >
              Launch Sandbox
            </Link>
          </div>
        ...
        <section id="features" className="w-full pt-28">
          <div className="text-center mb-16">
            <h2 className="text-sm font-semibold tracking-widest text-cyan-400 uppercase font-mono mb-2">Features</h2>
